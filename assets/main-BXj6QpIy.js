import{i as C,r as p,a as E,b as i,t as A,n as F,l as J,c as Q,d as ee,e as te}from"./content-browser-CxJTpHP2.js";const R="https://clanka-api.clankamode.workers.dev",ae=new Date("2026-02-19T00:00:00Z"),H=5e3,re=Date.parse("2008-01-01T00:00:00Z"),se=300*1e3;function ne(e){if(typeof e!="string"||e.trim().length===0)return null;const t=Date.parse(e);if(!Number.isFinite(t))return null;const a=Date.now();return t<re||t>a+se?null:t}function U(e){const t=Date.now()-e;if(!Number.isFinite(t)||t<0)return"just now";const a=Math.floor(t/1e3),s=Math.floor(a/60),r=Math.floor(s/60),n=Math.floor(r/24);return n>0?`${n}d ago`:r>0?`${r}h ago`:s>0?`${s}m ago`:"just now"}function oe(){const e=Date.now()-ae.getTime();return Math.floor(e/(1e3*60*60*24))}function b(e,t){const a=document.getElementById(e);a&&(a.textContent=t)}async function ie(){b("stat-uptime",`// ${oe()}d online`);try{const e=new AbortController,t=window.setTimeout(()=>e.abort(),H),a=await fetch(`${R}/github/stats`,{headers:{Accept:"application/json"},signal:e.signal});if(window.clearTimeout(t),!a.ok)throw new Error(`API ${a.status}`);const s=await a.json();b("stat-repos",`${s.repoCount} repos`),b("stat-stars",`${s.totalStars} stars`);const r=ne(s.lastPushedAt),n=typeof s.lastPushedRepo=="string"?s.lastPushedRepo.trim():"";r===null?b("stat-last-commit","last push: unavailable"):n.length===0?b("stat-last-commit",`last push: ${U(r)}`):b("stat-last-commit",`last push: ${U(r)} (${n})`);const o=new AbortController,u=window.setTimeout(()=>o.abort(),H);try{const d=await fetch(`${R}/fleet/summary`,{headers:{Accept:"application/json"},signal:o.signal});if(window.clearTimeout(u),!d.ok)throw new Error(`API ${d.status}`);const m=await d.json(),c=Number(m.totalRepos);Number.isFinite(c)&&c>0&&b("stat-fleet-score",`fleet: ${c} repos`)}catch{}finally{window.clearTimeout(u)}}catch{}}const ce="https://api.npmjs.org/downloads/point/last-month/@clankamode%2Fci-failure-triager",le=5e3;async function de(){const e=document.getElementById("npm-ci-triage");if(!e)return;let t=0;try{const a=new AbortController;t=window.setTimeout(()=>a.abort(),le);const s=await fetch(ce,{headers:{Accept:"application/json"},signal:a.signal});if(!s.ok)throw new Error(`NPM API ${s.status}`);const r=await s.json(),n=typeof r.downloads=="number"?r.downloads:null;if(n===null)throw new Error("Malformed downloads payload");e.textContent=`${n} dl/mo`}catch{e.textContent="–"}finally{window.clearTimeout(t)}}const pe="https://clanka-api.clankamode.workers.dev/github/events",ue=5e3,Y=["feat","fix","chore","docs","test","refactor","ci","build","style"];function me(e){const t=new Date(e).getTime(),a=Date.now()-t,s=Math.floor(a/1e3),r=Math.floor(s/60),n=Math.floor(r/60),o=Math.floor(n/24);return o>0?`${o}d ago`:n>0?`${n}h ago`:r>0?`${r}m ago`:"just now"}function fe(e){return e.replace(/^clankamode\//,"")}function ge(e){const a=e.trim().toLowerCase().match(/^([a-z]+)/),s=a?a[1]:"";return Y.includes(s)?s:"push"}function he(e){return Array.isArray(e)?e:Array.isArray(e.events)?e.events:[]}function q(e){const t=document.getElementById("commit-feed");if(!t)return;t.textContent="";const a=document.createElement("span");a.className="commit-feed-loading",a.textContent=e,t.append(a)}async function ve(){const e=document.getElementById("commit-feed");if(e)try{const t=new AbortController,a=window.setTimeout(()=>t.abort(),ue),s=await fetch(pe,{headers:{Accept:"application/json"},signal:t.signal});if(window.clearTimeout(a),!s.ok)throw new Error(`GitHub events API ${s.status}`);const r=await s.json(),n=he(r);if(!Array.isArray(n)||n.length===0){q("// no activity data");return}e.textContent="",n.slice(0,8).forEach(o=>{const u=fe(o.repo||"unknown"),d=o.message||"",m=ge(d),c=Y.includes(m)?m:"push",l=document.createElement("div");l.className="commit-item";const g=document.createElement("span");g.className="commit-repo",g.textContent=u;const h=document.createElement("span");h.className=`commit-tag commit-tag--${c}`,h.textContent=m;const v=document.createElement("span");v.className="commit-time",v.textContent=o.timestamp?me(o.timestamp):"just now",l.append(g,h,v),e.append(l)})}catch{q("// no activity data")}}const be="https://clanka-api.clankamode.workers.dev",ye=15e3,K=new Map,z=new Map;function xe(e){return`${be}${e}`}async function W(e,t=ye){const a=xe(e),s=K.get(a),r=Date.now();if(s&&s.expiresAt>r)return s.data;const n=z.get(a);if(n)return n;const o=(async()=>{const u=await fetch(a,{headers:{Accept:"application/json"}});if(!u.ok)throw new Error(`API ${u.status}`);const d=await u.json();return K.set(a,{data:d,expiresAt:Date.now()+t}),d})();z.set(a,o);try{return await o}finally{z.delete(a)}}function we(){return W("/now")}function ke(){return W("/fleet/summary")}var $e=Object.defineProperty,Ce=Object.getOwnPropertyDescriptor,T=(e,t,a,s)=>{for(var r=s>1?void 0:s?Ce(t,a):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(r=(s?o(t,a,r):o(r))||r);return s&&r&&$e(t,a,r),r};let f=class extends E{constructor(){super(...arguments),this.current="[ loading... ]",this.status="OPERATIONAL",this.history=[],this.loading=!0,this.error=""}connectedCallback(){super.connectedCallback(),this.setAttribute("role","region"),this.setAttribute("aria-label","Clanka live presence"),this.hasAttribute("tabindex")||(this.tabIndex=0)}disconnectedCallback(){this.pollId&&window.clearInterval(this.pollId),super.disconnectedCallback()}async firstUpdated(){await this.updatePresence(),this.pollId=window.setInterval(()=>this.updatePresence(),3e4)}async updatePresence(){this.loading=!0,this.error="",this.dispatchEvent(new CustomEvent("sync-state",{detail:{loading:!0,error:""}}));try{const e=await we();this.current=typeof e.current=="string"?e.current:"active",this.status=typeof e.status=="string"?e.status:"operational",this.history=Array.isArray(e.history)?e.history:[],this.dispatchEvent(new CustomEvent("sync-updated",{detail:e}))}catch{this.error="[ api unreachable ]",this.current="[ offline ]",this.status="offline",this.dispatchEvent(new CustomEvent("sync-error",{detail:{error:this.error}}))}finally{this.loading=!1,this.dispatchEvent(new CustomEvent("sync-state",{detail:{loading:!1,error:this.error}}))}}render(){const e=this.status.toLowerCase();return i`
  ...
  `;N([p()],w.prototype,"events",2);N([p()],w.prototype,"loading",2);N([p()],w.prototype,"error",2);w=N([A("clanka-activity")],w);var _e=Object.defineProperty,Ie=Object.getOwnPropertyDescriptor,P=(e,t,a,s)=>{for(var r=s>1?void 0:s?Ie(t,a):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(r=(s?o(t,a,r):o(r))||r);return s&&r&&_e(t,a,r),r};const O=["ops","infra","core","quality","policy","template"];let y=class extends E{constructor(){super(...arguments),this.repos=[],this.live=!1,this.loading=!0,this.error=""}connectedCallback(){super.connectedCallback(),this.setAttribute("role","region"),this.setAttribute("aria-label","Fleet status"),this.hasAttribute("tabindex")||(this.tabIndex=0),this.loadFleet()}async loadFleet(){this.loading=!0,this.error="";try{const e=await ke(),t=this.extractRepos(e);if(!t.length)throw new Error("No fleet repos in payload");this.repos=t,this.live=!0}catch{this.repos=[],this.live=!1,this.error="[ api unreachable ]"}finally{this.loading=!1}}extractRepos(e){const t=this.pickRepoArray(e);return t.length?t.map(a=>this.normalizeRepo(a)).filter(a=>a!==null).sort((a,s)=>{const r=O.indexOf(a.tier)-O.indexOf(s.tier);return r!==0?r:a.repo.localeCompare(s.repo)}):[]}pickRepoArray(e){if(!e||typeof e!="object")return[];const t=e;if(Array.isArray(t.repos))return t.repos;if(Array.isArray(t.fleet))return t.fleet;if(t.summary&&typeof t.summary=="object"){const a=t.summary;if(Array.isArray(a.repos))return a.repos;if(Array.isArray(a.fleet))return a.fleet}return[]}readOnlineState(e){if(typeof e.online=="boolean")return e.online;const t=String(e.status??e.state??"").trim().toLowerCase();return t?["offline","down","error","failed","degraded"].includes(t)?!1:["online","up","ok","healthy","active"].includes(t)?!0:null:null}normalizeRepo(e){if(!e||typeof e!="object")return null;const t=e,a=String(t.repo??t.name??t.full_name??"").trim(),s=String(t.tier??"").trim().toLowerCase(),r=String(t.criticality??t.priority??"").trim().toLowerCase(),n=this.readOnlineState(t);return!a||!O.includes(s)?null:["critical","high","medium"].includes(r)?{repo:a,tier:s,criticality:r,online:n}:{repo:a,tier:s,criticality:"medium",online:n}}shortName(e){return e.replace(/^clankamode\//,"")}render(){const e=O.map(t=>({tier:t,repos:this.repos.filter(a=>a.tier===t)})).filter(t=>t.repos.length>0);return i`
      <div class="sec-header">
  ...
  `;j([p()],k.prototype,"events",2);j([p()],k.prototype,"loading",2);j([p()],k.prototype,"error",2);k=j([A("clanka-terminal")],k);var Me=Object.getOwnPropertyDescriptor,Se=(e,t,a,s)=>{for(var r=s>1?void 0:s?Me(t,a):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(r=o(r)||r);return r};let B=class extends E{render(){return i`
      <div class="sec-header">
  ...
  `;B=Se([A("clanka-agents")],B);const De=3;function Ne(e){switch((e??"todo").trim().toLowerCase()){case"doing":return"doing";case"done":return"done";default:return"todo"}}function M(e,t){return String(e??t)}function je(e){return{statusClass:Ne(e.status),statusLabel:M(e.status,"TODO"),title:M(e.title,"untitled"),assignee:M(e.assignee,"unassigned"),priority:M(e.priority,"?")}}var Le=Object.defineProperty,ze=Object.getOwnPropertyDescriptor,L=(e,t,a,s)=>{for(var r=s>1?void 0:s?ze(t,a):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(r=(s?o(t,a,r):o(r))||r);return s&&r&&Le(t,a,r),r};let $=class extends E{constructor(){super(...arguments),this.tasks=[],this.loading=!0,this.error=""}connectedCallback(){super.connectedCallback(),this.setAttribute("role","region"),this.setAttribute("aria-label","Task board"),this.hasAttribute("tabindex")||(this.tabIndex=0)}render(){return i`
      <div class="sec-header">
      ...
      ${this.loading?i`
            <div class="fallback"><span class="loading">[ loading... ]</span></div>
            <div class="grid">
              ${Array.from({length:De}).map(()=>i`<div class="task-card" aria-hidden="true">
          ...
          `:this.error?i`<div class="fallback">${this.error}</div>`:this.tasks.length===0?i`<div class="fallback">[ no tasks ]</div>`:i`
                <div class="grid" role="list">
                  ${this.tasks.map(e=>{const t=je(e);return i`
  ...
  `;L([F({type:Array})],$.prototype,"tasks",2);L([F({type:Boolean})],$.prototype,"loading",2);L([F({type:String})],$.prototype,"error",2);$=L([A("clanka-tasks")],$);async function Be(){const e=document.getElementById("homepage-featured-log"),t=document.getElementById("homepage-log-preview"),a=document.getElementById("homepage-topic-preview"),s=document.getElementById("stat-posts"),r=document.getElementById("stat-audio-posts"),n=document.getElementById("logs-archive-link-count"),{featured:o,recent:u,topics:d,counts:m}=(await J()).homepage;if(e&&o){e.textContent="";const c=document.createElement("a");c.className="featured-log",c.href=o.canonicalPath;const l=document.createElement("span");l.className="featured-kicker",l.textContent=`latest dispatch · ${o.date}`;const g=document.createElement("span");g.className="featured-title",g.textContent=`${String(o.number).padStart(3,"0")}: ${o.title}`;const h=document.createElement("span");h.className="featured-snippet",h.textContent=o.summary;const v=document.createElement("span");v.className="featured-read",v.textContent="READ →",c.append(l,g,h,v),e.append(c)}t&&(t.textContent="",u.filter(c=>c.slug!==o?.slug).slice(0,5).forEach(c=>{t.append(Q(c))})),a&&(a.textContent="",d.forEach(c=>{a.append(ee(c))})),s&&(s.textContent=`${String(m.posts).padStart(3,"0")} posts`),r&&(r.textContent=`${String(m.audioPosts).padStart(3,"0")} with audio`),n&&(n.textContent=`browse all ${m.posts} dispatches`)}const S=document.getElementById("presence"),_=document.getElementById("activity"),x=document.getElementById("terminal"),V=document.getElementById("agents"),I=document.getElementById("tasks"),G=(e,t)=>{const a=document.getElementById(e);a&&(a.textContent=t)},Fe=new Set(["active","online","busy","running","healthy","up"]),Re=e=>{if(!e||typeof e!="object")return null;const t=Object.values(e).filter(r=>r!==null&&typeof r=="object");if(!t.length)return null;let a=0,s=0;return t.forEach(r=>{const n=String(r.status??r.state??r.presence??"").trim().toLowerCase();n&&(s+=1,Fe.has(n)&&(a+=1))}),s>0?a:t.length},He=e=>typeof e.agents_active=="number"&&Number.isFinite(e.agents_active)&&e.agents_active>=0?Math.floor(e.agents_active):Re(e.team),D=({loading:e,error:t})=>{_&&(_.loading=e,_.error=t||""),x&&(x.loading=e,x.error=t||""),I&&(I.loading=e,I.error=t||"")};D({loading:!0,error:""});S&&(S.addEventListener("sync-state",e=>{const a=e.detail||{loading:!1,error:"[ api unreachable ]"};D(a)}),S.addEventListener("sync-updated",e=>{const a=e.detail||{};_&&(_.history=a.history||[]),x&&(x.team=a.team||{},x.recentActivity=a.history||[]),V&&(V.team=a.team||{}),I&&(I.tasks=a.tasks||[]);const s=He(a);s!==null&&G("stat-active-agents",`agents: ${s} active`),D({loading:!1,error:""})}),S.addEventListener("sync-error",e=>{const a=e.detail?.error||"[ api unreachable ]";G("stat-active-agents","agents: offline"),D({loading:!1,error:a})}));(()=>{if(window.matchMedia("(prefers-reduced-motion: reduce)").matches)return;const e=document.querySelector(".hero-statement"),t=document.querySelector(".cursor");if(!e)return;const a="I build systems<br><em>that outlast me.</em>",[,s="",r=""]=a.match(/^(.*?)<br><em>(.*?)<\/em>$/)||[],n="<br><em>",o="</em>",u=40,d=l=>l.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;");if(!s||!r)return;e.innerHTML="";const m=(l=0)=>{if(l>s.length){window.setTimeout(()=>c(0),200);return}e.innerHTML=d(s.slice(0,l)),window.setTimeout(()=>m(l+1),u)},c=(l=0)=>{if(l>r.length){e.innerHTML=d(s)+n+d(r)+o,t&&window.setTimeout(()=>{t.style.opacity="0",t.style.pointerEvents="none"},2e3);return}e.innerHTML=d(s)+n+d(r.slice(0,l)),window.setTimeout(()=>c(l+1),u)};m(0)})();te();Be();ie();de();ve();
