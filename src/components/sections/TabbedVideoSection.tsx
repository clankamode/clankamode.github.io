          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            {youtubeChannelId && (
              <a
                ...
                className="text-muted-foreground hover:text-red-400 font-medium flex items-center gap-1.5 group transition-colors"
              >
                <svg className="w-4 h-4 text-red-600 group-hover:text-red-400 transition-colors" fill="currentColor" viewBox="0 0 24 24">
