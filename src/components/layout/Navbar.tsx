      ...
      <div className="max-w-screen-xl flex justify-between items-center mx-auto p-2">
        ...
        <div className="hidden md:flex items-center justify-center justify-self-center">
          <div className="flex space-x-4">
            ...
            {isLoggedIn && (
              <Link href="/practice-test" className={`px-3 py-2 ${isActive('/practice-test') ? 'text-green-800' : 'text-white hover:text-green-800'}`}>
                Practice Test
              </Link>
            )}
        ...
        <ul className="flex flex-col font-medium border border-[#3e3e3e] rounded-lg bg-[#282828] mt-4">
          ...
          {isLoggedIn && (
            <li>
              <Link 
                href="/practice-test" 
                className={`block py-2 pl-3 pr-4 rounded ${isActive('/practice-test') ? 'text-[#2cbb5d] bg-[#2cbb5d]/20' : 'text-white'} hover:text-[#2cbb5d]`}
                onClick={() => setIsMenuOpen(false)}
              >
                Practice Test
              </Link>
